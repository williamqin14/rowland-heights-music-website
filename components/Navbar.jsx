  ...
  return (
    <nav className="flex justify-between items-center p-2 pb-1 bg-gray-900 text-white w-full">
      ...
      <div className={menuIcon ? 
        'md:hidden absolute top-[80px] right-0 flex justify-center items-center w-full h-[300px] bg-gray-900 text-white ease-in duration-250'
        :
        'md:hidden absolute top-[-100%] right-0 flex justify-center items-center w-full h-[300px] bg-gray-900 text-white text-center ease-in duration-250'
      }>
